...
**Plans**: 2 plans
Plans:
- [ ] 09-01-PLAN.md - Add packaged-adventure onboarding state, readiness tracking, and restart-safe startup transitions.
- [ ] 09-02-PLAN.md - Drive DM auto-opening, first-scene framing, and operator-facing startup guidance from module data.
...
**Plans**: 2 plans
Plans:
- [ ] 10-01-PLAN.md - Integrate a mature dice library and replace placeholder roll resolution in the rules layer.
- [ ] 10-02-PLAN.md - Expose structured checks, saves, attacks, and damage across commands, combat flow, and narration summaries.
...
**Plans**: 2 plans
Plans:
- [ ] 11-01-PLAN.md - Add progressive Discord response transport and streaming-aware narrator plumbing.
- [ ] 11-02-PLAN.md - Harden natural-message routing, ignored-input feedback, and packaged-adventure message handling.
...
| 9. Adventure Onboarding And Auto-Opening | 0/2 | Planned | - |
| 10. Mature Dice Engine And Deterministic Roll Resolution | 0/2 | Planned | - |
| 11. Streaming Responses And Message Reliability | 0/2 | Planned | - |
